...
log "官方文档已同步完成。"
run_logged proot-distro login ubuntu -- bash -lc 'set -euo pipefail; mkdir -p "$HOME/product-docs"; ln -sfn /data/data/com.termux/files/home/product-docs/official "$HOME/product-docs/official"; ln -sfn /data/data/com.termux/files/home/product-docs/agent-notes "$HOME/product-docs/agent-notes"; printf "%s\n" "$HOME/product-docs/official"'
